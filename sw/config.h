...
#define IRQ_GPIO            18
#define IRQ_IDMA            19
// croc_pkg::UserBaseAddr(0x20000000) + wl_pkg::HwpeWmemBaseAddr(0x00050000)
#define WAKELET_PMEM_ADDR       0x20050000
// croc_pkg::UserBaseAddr(0x20000000) + wl_pkg::HwpeNqmemBaseAddr(0x00060000)
#define WAKELET_NQMEM_ADDR      0x20060000
